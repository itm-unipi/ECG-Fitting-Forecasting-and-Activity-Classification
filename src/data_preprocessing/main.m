...
[features_matrix, activities_targets_vector] = get_features_matrix(RESOURCES_PATH, WINDOW_SHIFT, WINDOW_SIZE, ACTIVITIES);

save('../tmp/non_normalised_features_matrix', 'features_matrix');
save('../tmp/non_augmented_activities_targets_vector', 'activities_targets_vector');
...
load('../tmp/non_augmented_activities_targets_vector');

[augmented_features_matrix, augmented_ecg_mean_targets_vector, augmented_ecg_std_targets_vector, augmented_activities_targets_vector] = get_augmented_data( ...
    K_FOLD_WINDOW_SIZE, AUGMENTATION_FACTOR, uncorrelated_features_matrix, ecg_mean_targets_vector, ecg_std_targets_vector, activities_targets_vector);
...
final_features_activities_matrix = normalized_augmented_features_matrix(:, (fs_mean | fs_std));
